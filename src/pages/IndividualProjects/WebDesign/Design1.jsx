        ...
        <div className="design-flex-row">
          ...
          >
            ...
            <div className="design-tags-row">
              <span className="design-pill">Education Platform</span>
              <span className="design-pill">UI/UX Design</span>
              <span className="design-pill">Accessible Web</span>
            </div>
            ...
            >
              <div className={`design-image-inner${hover ? ' design-image-inner-hover' : ''}`} style={{ overflow: 'hidden', padding: 0 }}>
                <iframe 
                  ...
                  title="Aarohan Video Walkthrough"
                />
              </div>
            </div>
          </motion.div>
