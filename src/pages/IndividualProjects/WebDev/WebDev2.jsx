    ...
    <div style={{ minHeight: '100vh', background: '#0A0A1B', display: 'flex', flexDirection: 'column', padding: isMobile ? (isVerySmallScreen ? '0 12px' : '0 16px') : 0 }}>
      ...
      >
          ...
          >
            ...
            >
              <iframe 
                ...
                title="Gym Website Video Walkthrough"
              />
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <Button2 href="https://fit-zone-u3m9.vercel.app/" target="_blank" rel="noopener noreferrer" style={{ width: 'fit-content', minWidth: '40px' }}>View Project</Button2>
        </motion.div>
      </motion.div>
